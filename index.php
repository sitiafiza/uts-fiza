...
<head>
  <title>Maza - Shoes Online Store </title>
  <meta charset="utf-8">
            ...
            <div class="summary">
              <div class="summary-content fs-6">
                <div class="product-header d-flex justify-content-between mt-4">
                  <h3 class="display-7">sepatu lari</h3>
                  <div class="modal-close-btn">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                  </div>
                </div>
                <span class="product-price fs-3">Rp1.500.000</span>
                  ...
                  <div class="col-lg-9 col-md-8 col-sm-8">
                    ...
                    <div class="quantity-price d-flex justify-content-between align-items-center">
                      ...
                      <div class="price-code">
                        <span class="product-price fs-6">Rp300.001</span>
                      </div>
                    </div>
                    <!-- quantity-price -->
                  </div>
            ...
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">sepatu keren</a>
                </h3>
                <span class="card-price fw-bold">Rp100.000</span>
              </div>
            </div>
          </div>
          <div class="col mb-4">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">sepatu LV</a>
                </h3>
                <span class="card-price fw-bold">Rp15.000.000</span>
              </div>
            </div>
          </div>
          <div class="col mb-4">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">Nike Shoes</a>
                </h3>
                <span class="card-price fw-bold">Rp4.000.000</span>
              </div>
            </div>
          </div>
          <div class="col mb-4">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">Pretty Shoes Channel</a>
                </h3>
                <span class="card-price fw-bold">Rp20.000.000</span>
              </div>
            </div>
          </div>
          <div class="col mb-4">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">Filla Shoes</a>
                </h3>
                <span class="card-price fw-bold">Rp500.000</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">Dior Shoes</a>
                </h3>
                <span class="card-price fw-bold">Rp150.000.009</span>
              </div>
            </div>
          </div>
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.html">LV Shoes 2023</a>
                </h3>
                <span class="card-price fw-bold">Rp.6.000.000</span>
              </div>
            </div>
          </div>
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">CELINE Shoes</a>
                </h3>
                <span class="card-price fw-bold">Rp199.999.999</span>
              </div>
            </div>
          </div>
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="create.php">Original Shoes</a>
                </h3>
                <span class="card-price fw-bold">Rp510.000</span>
              </div>
            </div>
          </div>
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              ...
              <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                <h3 class="card-title fs-6 fw-normal m-0">
                  <a href="createx.php">Original Shoes 2</a>
                </h3>
                <span class="card-price fw-bold">Rp450.000</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container-lg">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-lg-end">
          <a href="create.php" class="btn btn-primary">Pesan disini</a>
        </div>        
      </div>
    </div>
  </footer>
